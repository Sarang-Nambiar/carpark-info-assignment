...
const { create_tables } = require("./setupQueries");
...
const db = new sqlite3.Database(":memory:", async (err) => {
  ...
  const userResult = await getQuery("SELECT * FROM User");
  if(!userResult){
...
// Function to parse free parking string into day, start_time and end_time fields
...
// Function to insert data into the normal form tables
...
// Function to update data in the normal form tables
...
// Function to delete data in the normal form tables
